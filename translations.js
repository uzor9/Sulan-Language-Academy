...
const translations = {
  ...
  en: {
    ...
    portugueseDescription: "Learn Brazilian and European Portuguese with practical lessons focused on fluency and confidence.",

    frenchTitle: "French",
    frenchDescription: "French coaching is currently in development. Join the waiting list to be notified when classes become available.",

    viewCourse: "View Course",
    waitingList: "Join Waiting List",

    // Trial section
    trialTitle: "Book a Free 30-Minute Trial Lesson",
    trialDescription: "Experience a real lesson before committing to a course. We'll discuss your goals, assess your current level, and create a personalized learning plan for you.",
    noPayment: "No payment required",
    assessment: "Personalized language assessment",
    availableLanguages: "Available for English, Spanish, Portuguese",
...
aboutHeroSubtitle: "Helping students become fluent, confident, and globally connected through practical language coaching.",

aboutGreeting: "Hi, I'm Uzor",

aboutIntro: "I'm the founder of Sulan Language Academy, where I help students learn English, Spanish, Portuguese, and French through practical conversations, personalized lessons, and real-world communication.",

aboutTeachingStyle: "My teaching style focuses on confidence first. I want you to be able to speak naturally, understand native speakers, travel comfortably, and use your language skills for work, business, and international opportunities.",

aboutLearningGoals: "Whether you're preparing for a job interview, studying abroad, moving to another country, or simply learning for fun, I'll create a learning plan that fits your level and your goals.",

personalizedCoaching: "Personalized Coaching",
personalizedCoachingDescription: "Every lesson is adapted to your level, goals, and learning style.",

realConversations: "Real Conversations",
realConversationsDescription: "Learn how native speakers actually communicate in everyday life and business.",

globalOpportunities: "Global Opportunities",
globalOpportunitiesDescription: "Build language skills that help with travel, work, study, and international connections.",

contactHeroTitle: "Let's Talk",
contactHeroSubtitle: "Have questions about lessons, pricing, or your language goals? Send me a message and I'll get back to you within 24 hours.",

email: "Email",
whatsapp: "WhatsApp",
wechat: "WeChat",
wechatAvailability: "Available for Chinese students",

sendMessage: "Send Message",

yourName: "Your Name",
yourEmail: "Your Email",
learningMessage: "Tell me what you'd like to learn...",

startYourJourney: "START YOUR JOURNEY",

enrollmentTitle: "Find the Right Language Course for You",

enrollmentSubtitle: "Tell me a little about yourself and your goals. I'll use your answers to understand your needs and recommend the best learning approach for you.",
...
languageToLearn: "What language do you want to learn?",
...
joinFrenchWaitingList: "Join the Waiting List",
  ...
  es: {
    ...
    portugueseTitle: "Portugués",
    portugueseDescription: "Aprende portugués brasileño y europeo con clases prácticas centradas en la fluidez y la confianza.",

    frenchTitle: "Francés",
    frenchDescription: "El coaching de francés está actualmente en desarrollo. Únete a la lista de espera para recibir una notificación cuando las clases estén disponibles.",

    viewCourse: "Ver Curso",
    waitingList: "Unirse a la Lista de Espera",

    // Trial section
    trialTitle: "Reserva una Clase de Prueba Gratuita de 30 Minutos",
    trialDescription: "Experimenta una clase real antes de comprometerte con un curso. Hablaremos sobre tus objetivos, evaluaremos tu nivel actual y crearemos un plan de aprendizaje personalizado para ti.",
    noPayment: "No se requiere pago",
    assessment: "Evaluación personalizada de idiomas",
    availableLanguages: "Disponible para inglés, español y portugués",
...
aboutGreeting: "Hola, soy Uzor",

aboutIntro: "Soy el fundador de Sulan Language Academy, donde ayudo a los estudiantes a aprender inglés, español, portugués y francés mediante conversaciones prácticas, clases personalizadas y comunicación del mundo real.",

aboutTeachingStyle: "Mi método de enseñanza se centra primero en la confianza. Quiero que puedas hablar de forma natural, entender a hablantes nativos, viajar cómodamente y utilizar tus conocimientos de idiomas para el trabajo, los negocios y las oportunidades internacionales.",

aboutLearningGoals: "Ya sea que te estés preparando para una entrevista de trabajo, estudiando en el extranjero, mudándote a otro país o simplemente aprendiendo por diversión, crearé un plan de aprendizaje adaptado a tu nivel y tus objetivos.",

personalizedCoaching: "Clases Personalizadas",
personalizedCoachingDescription: "Cada clase se adapta a tu nivel, tus objetivos y tu estilo de aprendizaje.",

realConversations: "Conversaciones Reales",
realConversationsDescription: "Aprende cómo se comunican realmente los hablantes nativos en la vida cotidiana y en los negocios.",

globalOpportunities: "Oportunidades Globales",
globalOpportunitiesDescription: "Desarrolla habilidades lingüísticas que te ayuden con los viajes, el trabajo, los estudios y las conexiones internacionales.",
  
contactHeroTitle: "Hablemos",
contactHeroSubtitle: "¿Tienes preguntas sobre las clases, los precios o tus objetivos lingüísticos? Envíame un mensaje y te responderé en un plazo de 24 horas.",

email: "Correo electrónico",
whatsapp: "WhatsApp",
wechat: "WeChat",
wechatAvailability: "Disponible para estudiantes chinos",

sendMessage: "Enviar mensaje",

yourName: "Tu nombre",
yourEmail: "Tu correo electrónico",
learningMessage: "Cuéntame qué te gustaría aprender...",

startYourJourney: "COMIENZA TU VIAJE",

enrollmentTitle: "Encuentra el Curso de Idiomas Adecuado para Ti",

enrollmentSubtitle: "Cuéntame un poco sobre ti y tus objetivos. Utilizaré tus respuestas para comprender tus necesidades y recomendarte el mejor método de aprendizaje.",
...
languageToLearn: "¿Qué idioma quieres aprender?",
...
joinFrenchWaitingList: "Unirme a la lista de espera",
  ...
  pt: {
    ...
    portugueseDescription: "Aprenda português brasileiro e europeu com aulas práticas focadas em fluência e confiança.",

    frenchTitle: "Francês",
    frenchDescription: "O coaching de francês está atualmente em desenvolvimento. Entre na lista de espera para receber uma notificação quando as aulas estiverem disponíveis.",

    viewCourse: "Ver Curso",
    waitingList: "Entrar na Lista de Espera",

    // Trial section
    trialTitle: "Agende uma Aula Experimental Gratuita de 30 Minutos",
    trialDescription: "Experimente uma aula real antes de se comprometer com um curso. Vamos conversar sobre seus objetivos, avaliar seu nível atual e criar um plano de aprendizagem personalizado para você.",
    noPayment: "Nenhum pagamento necessário",
    assessment: "Avaliação personalizada de idioma",
    availableLanguages: "Disponível para inglês, espanhol e português",
...
aboutHeroSubtitle: "Ajudando alunos a alcançar fluência, confiança e conexões globais por meio de aulas práticas de idiomas.",

aboutGreeting: "Olá, eu sou Uzor",

aboutIntro: "Sou o fundador da Sulan Language Academy, onde ajudo alunos a aprender inglês, espanhol, português e francês por meio de conversas práticas, aulas personalizadas e comunicação do mundo real.",

aboutTeachingStyle: "Meu método de ensino coloca a confiança em primeiro lugar. Quero que você consiga falar naturalmente, entender falantes nativos, viajar com tranquilidade e usar suas habilidades linguísticas no trabalho, nos negócios e em oportunidades internacionais.",

aboutLearningGoals: "Seja para se preparar para uma entrevista de emprego, estudar no exterior, mudar-se para outro país ou simplesmente aprender por diversão, criarei um plano de aprendizagem que se adapte ao seu nível e aos seus objetivos.",

personalizedCoaching: "Aulas Personalizadas",
personalizedCoachingDescription: "Cada aula é adaptada ao seu nível, aos seus objetivos e ao seu estilo de aprendizagem.",

realConversations: "Conversas Reais",
realConversationsDescription: "Aprenda como os falantes nativos realmente se comunicam no dia a dia e nos negócios.",

globalOpportunities: "Oportunidades Globais",
globalOpportunitiesDescription: "Desenvolva habilidades linguísticas que ajudam em viagens, trabalho, estudos e conexões internacionais.",

contactHeroTitle: "Vamos Conversar",
contactHeroSubtitle: "Tem dúvidas sobre as aulas, os preços ou os seus objetivos linguísticos? Envie-me uma mensagem e responderei dentro de 24 horas.",

email: "E-mail",
whatsapp: "WhatsApp",
wechat: "WeChat",
wechatAvailability: "Disponível para estudantes chineses",

sendMessage: "Enviar mensagem",

yourName: "Seu nome",
yourEmail: "Seu e-mail",
learningMessage: "Conte-me o que você gostaria de aprender...",

startYourJourney: "COMECE SUA JORNADA",

enrollmentTitle: "Encontre o Curso de Idiomas Ideal para Você",

enrollmentSubtitle: "Conte-me um pouco sobre você e seus objetivos. Usarei suas respostas para entender suas necessidades e recomendar a melhor abordagem de aprendizagem para você.",
...
languageToLearn: "Qual idioma você quer aprender?",
selectLanguage: "Selecione um idioma",

currentLevel: "Qual é o seu nível atual?",
...
joinFrenchWaitingList: "Entrar na lista de espera",
  ...
  zh: {
    ...
    portugueseTitle: "葡萄牙语",
    portugueseDescription: "学习巴西葡萄牙语和欧洲葡萄牙语，通过实用课程提升流利度和自信心。",

    frenchTitle: "法语",
    frenchDescription: "法语课程目前正在开发中。加入候补名单，课程开放后我们会通知你。",

    viewCourse: "查看课程",
    waitingList: "加入候补名单",

    // Trial section
    trialTitle: "预约30分钟免费试听课",
    trialDescription: "在报名课程之前体验真实的课堂。我们会了解你的目标、评估你的当前水平，并为你制定个性化的学习计划。",
    noPayment: "无需付款",
    assessment: "个性化语言评估",
    availableLanguages: "提供英语、西班牙语和葡萄牙语课程",
    bookTrial: "预约我的免费试听课",
...
aboutHeroSubtitle: "通过实用的语言培训，帮助学生提高流利度、自信心，并建立全球联系。",

aboutGreeting: "你好，我是 Uzor",

aboutIntro: "我是 Sulan Language Academy 的创始人，通过实用对话、个性化课程和真实场景交流，帮助学生学习英语、西班牙语、葡萄牙语和法语。",

aboutTeachingStyle: "我的教学方式首先注重建立自信。我希望你能够自然地交流，听懂母语者的表达，轻松旅行，并将语言技能运用到工作、商务和国际机会中。",

aboutLearningGoals: "无论你是在准备求职面试、出国留学、搬到另一个国家，还是单纯出于兴趣学习，我都会根据你的水平和目标为你制定个性化的学习计划。",

personalizedCoaching: "个性化辅导",
personalizedCoachingDescription: "每节课都会根据你的水平、目标和学习方式进行调整。",

realConversations: "真实对话",
realConversationsDescription: "学习母语者在日常生活和商务场景中真正使用的交流方式。",

globalOpportunities: "全球机会",
globalOpportunitiesDescription: "培养能够帮助你旅行、工作、学习以及建立国际联系的语言技能。",

contactHeroTitle: "让我们聊聊",
contactHeroSubtitle: "对课程、价格或你的语言学习目标有疑问吗？给我发一条消息，我会在24小时内回复你。",

email: "电子邮箱",
whatsapp: "WhatsApp",
wechat: "微信",
wechatAvailability: "为中国学生提供服务",

sendMessage: "发送消息",

yourName: "您的姓名",
yourEmail: "您的邮箱",
learningMessage: "告诉我您想学习什么...",

startYourJourney: "开始您的语言学习之旅",

enrollmentTitle: "找到适合您的语言课程",

enrollmentSubtitle: "请告诉我一些关于您自己和学习目标的信息。我会根据您的回答了解您的需求，并为您推荐最适合的学习方式。",
...
languageToLearn: "您想学习哪种语言？",
selectLanguage: "请选择一种语言",

currentLevel: "您目前的语言水平如何？",
selectLevel: "请选择您的水平",
completeBeginner: "零基础",
